...
> = {
  ...
  meta: {
    modelProps: 'user' | 'refreshToken' | 'subscription' | 'usageLog' | 'streamSession' | 'smsCode';
    ...
    StreamSession: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.StreamSessionCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type UsageLogScalarFieldEnum =
  (typeof UsageLogScalarFieldEnum)[keyof typeof UsageLogScalarFieldEnum];
...
export type StreamSessionScalarFieldEnum =
  (typeof StreamSessionScalarFieldEnum)[keyof typeof StreamSessionScalarFieldEnum];
...
export type SmsCodeScalarFieldEnum =
  (typeof SmsCodeScalarFieldEnum)[keyof typeof SmsCodeScalarFieldEnum];
